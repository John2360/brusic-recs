...
def playlist_recommendations(playlist_id):
    ...
    playlist = spotify.playlist_tracks(playlist_id, track_anyalysis=True, playlist_filter=playlist_filter, recommendations=True, recommendations_filter=recommendations_filter)
